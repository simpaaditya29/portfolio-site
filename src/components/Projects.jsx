const projects = [
  {
    ...
    description:
      'Onyx is a from-scratch chess engine wrapped in a full training app. v6.0 adds a rich analytics dashboard, flexible training modes, and a standalone desktop build. Work is still ongoing, and more features will arrive soon!',
    highlights: [
    ...
    githubUrl: 'https://github.com/simpaaditya29/onyx-chess',
    terminalName: 'onyx-engine — active',
    terminalLines: [
      ...
      { text: 'status: installing new updates...', dim: true },
    ],
  },
  {
    name: 'PitchPulse-AI',
    ...
    status: '🚧 Active Development',
    description:
      'An advanced data analytics platform designed to process large-scale datasets, run clustering models, and extract actionable insights. This project is constantly evolving as new machine learning features are integrated.',
    highlights: [
      'Customer segmentation and clustering models',
      'Data manipulation and cleaning using Pandas',
      'Actionable visual reports and insights',
      'Ongoing optimization of machine learning algorithms',
    ],
    tags: ['Python', 'Pandas', 'Machine Learning', 'Data Analytics', 'SQL'],
    githubUrl: 'https://github.com/simpaaditya29/pitchpulse-ai',
    terminalName: 'pitchpulse-ai — dev',
    terminalLines: [
      { text: 'pitchpulse run --analyze dataset.csv', dim: true },
      { text: '> loading data... 100%', dim: true },
      { text: 'clustering complete: 5 segments identified', bright: true },
      { text: 'generating visualization reports...', dim: true },
      { text: 'model optimization in progress ⏳', bright: true },
    ],
  }
];
    ...
    <section id="projects" className="mx-auto max-w-6xl px-6 py-24">
      <div className="max-w-2xl">
        ...
        <p className="mt-4 text-slate-400">
          Designed, engineered, and shipped end to end. I am actively developing these tools to expand their capabilities.
        </p>
      </div>

      <div className="mt-16 space-y-24">
        {projects.map((project) => (
          <div key={project.name} className="grid items-stretch gap-8 lg:grid-cols-2">
            {/* Terminal mockup */}
            <div className="flex flex-col">
              <div className="flex-1 overflow-hidden rounded-xl border border-white/10 bg-slate-900/70 shadow-2xl shadow-black/40">
                <div className="flex items-center gap-2 border-b border-white/10 bg-slate-900 px-4 py-3">
                  ...
                  <span className="ml-3 font-mono text-xs text-slate-400">{project.terminalName}</span>
                </div>
            ...
            <div className="flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-white flex items-center gap-3">
                {project.name} 
                <span className="text-sm font-medium text-emerald-400 bg-emerald-400/10 px-2 py-1 rounded-md border border-emerald-400/20">
                  {project.status}
                </span>
              </h3>
